/* Regression (GCC PR tree-optimization/27285, reduced): a loop-carried value
   ...
   clobbered the shared home, tripping the stale-home ICE. The gap audit
   (and, post-slot, the home-collision veto) in the prologue replay scan
   must prune that record so the Cmp materializes its boolean instead. */
