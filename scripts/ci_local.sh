...
# Worst-15 follow-up (session 586): nbody pair-loop load CSE, same-value
# FP squares read the register once, rbtree hash derived-IV recurrence
# (negative-verified against the pre-session base: all four fail there).
