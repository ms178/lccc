...
.LBB0_14:
  imulq $200, %rcx, %rsi
  movzbl strings(%rsi), %r8d
  testb %r8b, %r8b
  je .LBB0_22
  leaq strings(%rsi), %rdi
.LBB0_16:
  movb $97, %r9b
  movl $1, %edx
  xorl %r11d, %r11d
...
.LBB0_22:
  xorl %edx, %edx
.LBB0_23:
  movzbl strings+200(%rsi), %r8d
  testb %r8b, %r8b
  je .LBB0_31
  leaq strings+200(%rsi), %rsi
  movq %rax, %rdi
.LBB0_25:
  movb $97, %r11b
  xorl %r10d, %r10d
