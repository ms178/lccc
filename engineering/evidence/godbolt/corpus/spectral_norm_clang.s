...
.LBB0_5:
  ...
  vfmadd132sd 64(%rsp,%rdx,8), %xmm1, %xmm2
  leal (%rax,%rdx), %esi
  addl $2, %esi
  imull %esi, %edi
  shrl %edi
  ...
  vfmadd132sd 72(%rsp,%rdx,8), %xmm2, %xmm1
  leal (%rax,%rdx), %edi
  addl $3, %edi
  imull %edi, %esi
  shrl %esi
  ...
  vcvtsi2sd %esi, %xmm15, %xmm2
  vdivsd %xmm2, %xmm0, %xmm2
  vfmadd132sd 80(%rsp,%rdx,8), %xmm1, %xmm2
  leal (%rax,%rdx), %esi
  addl $4, %esi
  imull %edi, %esi
  shrl %esi
  ...
  vdivsd %xmm1, %xmm0, %xmm1
  vfmadd132sd 88(%rsp,%rdx,8), %xmm2, %xmm1
  addq $4, %rdx
  cmpq $2000, %rdx
  jne .LBB0_5
...
.LBB0_9:
  ...
  movl %r8d, %r11d
  vdivsd %xmm2, %xmm0, %xmm2
  vfmadd132sd 32064(%rsp,%r13,8), %xmm1, %xmm2
  shrl %r11d
  addl %r13d, %r11d
  addl $2, %r11d
  ...
  movl %r9d, %r11d
  vdivsd %xmm1, %xmm0, %xmm1
  vfmadd132sd 32072(%rsp,%r13,8), %xmm2, %xmm1
  shrl %r11d
  movl %ebx, %esi
  addl %r13d, %r11d
  addl $3, %r11d
  ...
  shrl %esi
  vdivsd %xmm2, %xmm0, %xmm2
  vfmadd132sd 32080(%rsp,%r13,8), %xmm1, %xmm2
  addl %r13d, %esi
  addl $4, %esi
  vcvtsi2sd %esi, %xmm15, %xmm1
  vdivsd %xmm1, %xmm0, %xmm1
  vfmadd132sd 32088(%rsp,%r13,8), %xmm2, %xmm1
  addq $4, %r13
  addl %edx, %r9d
  addl $32, %edx
  addl %edi, %r8d
...
.LBB0_13:
  ...
  vcvtsi2sd %esi, %xmm15, %xmm2
  vdivsd %xmm2, %xmm0, %xmm2
  vfmadd132sd 16064(%rsp,%rdx,8), %xmm1, %xmm2
  leal (%rax,%rdx), %esi
  addl $2, %esi
  imull %esi, %edi
  shrl %edi
  ...
  vcvtsi2sd %edi, %xmm15, %xmm1
  vdivsd %xmm1, %xmm0, %xmm1
  vfmadd132sd 16072(%rsp,%rdx,8), %xmm2, %xmm1
  leal (%rax,%rdx), %edi
  addl $3, %edi
  imull %edi, %esi
  shrl %esi
  ...
  vcvtsi2sd %esi, %xmm15, %xmm2
  vdivsd %xmm2, %xmm0, %xmm2
  vfmadd132sd 16080(%rsp,%rdx,8), %xmm1, %xmm2
  leal (%rax,%rdx), %esi
  addl $4, %esi
  imull %edi, %esi
  shrl %esi
  ...
  vcvtsi2sd %esi, %xmm15, %xmm1
  vdivsd %xmm1, %xmm0, %xmm1
  vfmadd132sd 16088(%rsp,%rdx,8), %xmm2, %xmm1
  addq $4, %rdx
  cmpq $2000, %rdx
  jne .LBB0_13
  vmovsd %xmm1, 32064(%rsp,%rax,8)
