...
pub enum AsmItem {
    ...
    #[expect(dead_code)] // Parsed but skipped during encoding (debug info not yet emitted)
    File(u32, String),
    ...
    #[expect(dead_code)] // Parsed for RISC-V compatibility in shared parser; ignored on x86
...
pub struct SectionDirective {
    ...
    #[expect(dead_code)] // Parsed for completeness; will be used for SHF_LINK_ORDER sections
...
pub enum ImmediateValue {
    ...
    #[expect(dead_code)] // Constructed by parser; handled by encoder for GOT/TLS relocations
...
pub enum Displacement {
    ...
    #[expect(dead_code)] // Constructed by elf.rs numeric label resolver; consumed by encoder
