...
mod encoding_opt_tests {
    ...
    fn evex_vpermil() {
        ...
        assert_eq!(
            hex("vpermilpd $0xab, %zmm5, %zmm6"),
            "62 f3 fd 48 05 f5 ab"
        );
        assert_eq!(
        ...
        assert_eq!(
            hex("vpermilps $0xab, %zmm5, %zmm6"),
            "62 f3 7d 48 04 f5 ab"
        );
        assert_eq!(
    ...
    fn evex_vpconflict() {
        ...
        assert_eq!(
            hex("vpconflictd %zmm5, %zmm6{%k7}{z}"),
            "62 f2 7d cf c4 f5"
        );
        assert_eq!(hex("vpconflictq %zmm5, %zmm6"), "62 f2 fd 48 c4 f5");
        assert_eq!(
            hex("vpconflictq (%rax){1to8}, %zmm6"),
            "62 f2 fd 58 c4 30"
        );
    }
