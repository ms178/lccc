...
mod encoding_opt_tests {
    ...
    fn evex_sae_broadcast_and_cmp_cvt() {
        ...
        assert_eq!(hex("vmaxps {sae}, %zmm1, %zmm2, %zmm3"), "62 f1 6c 18 5f d9");
        assert_eq!(
        ...
        assert_eq!(
            hex("vcvtps2dq {rz-sae}, %zmm1, %zmm2"),
            "62 f1 7d 78 5b d1"
        );
        // GAS 2.47: EGPR as AVX-512 memory base (P0.B4, P1.!X4).
        assert_eq!(
            hex("vaddps (%r16), %zmm1, %zmm2"),
            "62 f9 74 48 58 10"
        );
        assert_eq!(
            hex("vaddps (%r20), %zmm1, %zmm2"),
            "62 f9 74 48 58 14 24"
        );
        assert_eq!(
        ...
        assert_eq!(
            hex("vaddps 64(%r16), %zmm1, %zmm2"),
            "62 f9 74 48 58 50 01"
        );
