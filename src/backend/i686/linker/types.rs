...
pub(super) const R_386_16: u32 = 20;
pub(super) const R_386_PC16: u32 = 21;
pub(super) const R_386_8: u32 = 22;
pub(super) const R_386_PC8: u32 = 23;
pub(super) const R_386_TLS_LE_32: u32 = 34;
pub(super) const R_386_SIZE32: u32 = 38;
...
pub(super) struct LinkerSymbol {
    ...
    pub sym_type: u8,
    pub binding: u8,
    #[expect(dead_code)] // Tracked for future STV_HIDDEN/STV_PROTECTED handling
    pub visibility: u8,
    pub is_defined: bool,
    pub needs_plt: bool,
    pub needs_got: bool,
