...
impl Lowerer {
    ...
    fn lower_member_access_impl(
        ...
        let is_vol = if is_pointer {
            self.pointee_expr_is_volatile(base_expr)
        } else {
