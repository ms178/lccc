...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_pabsw128(__a));
}
...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_pabsb128(__a));
}
...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_pabsd128(__a));
}
...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_pmaddubsw128(__a, __b));
}
...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_pshufb128(__a, __b));
}
...
#define _mm_alignr_epi8(__a, __b, __n) \
    (__m128i)(__builtin_ia32_palignr128((__a), (__b), (__n)))
...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_phaddw128(__a, __b));
}
...
{
    return __CCC_M128I_FROM_BUILTIN(__builtin_ia32_phaddd128(__a, __b));
}
